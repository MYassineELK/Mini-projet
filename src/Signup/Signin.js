...
<div className=' bg-black h-20 w-full'></div>
  ...
  <div className=" my-5 mx-auto md:px-6">
      ...
      <div className="container mx-auto xl:px-32">
        <div className=" grid items-center lg:grid-cols-2">
          <div className="mb-12 md:mt-12 lg:mt-0 lg:mb-0">
           ...
           <br /> <div className=' text-2xl font-serif '>Sing in</div>
  ...
  <p className="p">Don't have an account? <span className="span"><Link to="/Signup">Sign Up</Link> </span>

...
export default function Paye() {
  ...
  return (
    <div className=' '>
              ...
              <div className="modale container grid grid-cols-1 gap-y-3 sm:gap-x-3 sm:grid-cols-2 mb-1">
<center><form className="forme bg-white shadow-2xl w-96 sm:w-full">
  <div className="payment--options">
    <button name="paypal"  type="button">
      <svg xmlSpace="preserve" className=' sm:ml-0 -ml-6' viewBox="0 0 124 33" height="33px" width="124px" y="0px" x="0px" id="Layer_1" version="1.1" xmlnsXlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg">
    ...
    <button name="apple-pay" type="button">
      <svg className=' sm:ml-5 ml-2' xmlSpace="preserve" viewBox="0 0 512 210.2" y="0px" x="0px" id="Layer_1" version="1.1" xmlnsXlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg">
    ...
    <button name="google-pay" type="button">
      <svg fill="none" className=' sm:ml-0 -ml-2' viewBox="0 0 80 39" height={39} width={80} xmlns="http://www.w3.org/2000/svg">
  ...
  <div className="credit-card-info--form">
    <div className="input_container">
      <label htmlFor="password_field" className="input_label flex justify-start ">Card holder full name</label>
    ...
    <div className="input_container">
      <label htmlFor="password_field" className="input_label flex justify-start ">Card Number</label>
    ...
    <div className="input_container">
      <label htmlFor="password_field" className="input_label flex justify-start ">Expiry Date / CVV</label>
      <div className="split">
  ...
  <center>
  <button type="button" className=" bg-black text-white text-base w-11/12 rounded-md px-10  py-2.5" onClick={()=>setvisible(true)}>Checkout</button>
  </center>
</form></center>
...
<div className=' bg-white rounded-lg shadow-lg h-36'  >
       <center>
            ...
            <div className=' text-2xl font-serif'>CART TOTALS</div><br />
        ...
        <div className='text-gray-600 text-base'>{"$"+c+".00"}</div>
            ...
            {prodwi.map((e,k)=><div className=' bg-slate-100 rounded-2xl shadow-2xl w-11/12 mt-4 ' key={k}>
       <table>
        <tr>
            <td className=' h-24 sm:w-24'> <img src={e.img} className=' rounded-3xl sm:rounded-l-lg'  alt="" /></td>
            ...
            <td>
                ...
                <div className=' space-y-1 p-2'>
                    ...
                    <div className=' text-gray-700'>{e.desc.slice(0,70)}</div>
...
<center>
<div className={`fullbg  w-full `+`${visible?"block":"hidden"}`}>
<div className="card mt-14 "> 
  <button className="dismiss" type="button" onClick={()=>setvisible(false)}>X</button> 
  <div className="header"> 
    ...
    <div className="content">
      <span className="titleee">Order validated</span> 
